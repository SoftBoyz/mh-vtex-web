    ...
    return (
      <div>
        <img
          ...
          className={"image-" + this.props.img_side}
          alt={this.props.inf}
        />
        <span className={"title-" + this.props.text_side}>
          {this.props.inf}
        </span>
        <br />
  ...
  render() {
    return (
      <div>
        ...
        <div className="info">
          <Info
            text={`A smart é uma plataforma de transformação digital para pequenos e médios comerciantes 
          ...
          ></Info>
          <Info
            text={`A nossa proposta é intermediar uma relação entre duas ou mais empresas, 
          ...
          <Info
            text={`Primariamente lojas de comércio local; desde lojas que simplesmente querem entrar no 
          ...
          <Info
            text={`Apos cadastrar sua loja, você poderá inserir seus produtos ou ser um ponto 
          ...
          <Info
            text={`A loja separa o produto e espera a hora combinada com seus parceiros. Quando a hora chegar, a loja leva 
